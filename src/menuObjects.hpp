...
static const sf::Vector2f LOAD_BUTTON_POSITION(BASE_BUTTON_X_POSITION, BASE_BUTTON_Y_POSITION);
static const sf::Vector2f SAVE_BUTTON_POSITION(BASE_BUTTON_X_POSITION, 
